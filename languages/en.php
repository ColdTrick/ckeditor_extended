...
return array(
	...
	'ckeditor:settings:image_upload_allowed' => "Allow image upload in image dialog window of editor",
	'ckeditor:settings:show_html_toggler' => "Show the HTML toggler link",
	'ckeditor:settings:show_html_toggler:option:admin_only' => "Only for administrators",
);